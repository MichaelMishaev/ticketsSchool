...
export const badgeVariants = {
  success: "inline-flex items-center gap-1.5 px-2.5 py-1 bg-green-100 text-green-800 border border-green-200 rounded-full text-sm font-medium",
  warning: "inline-flex items-center gap-1.5 px-2.5 py-1 bg-amber-100 text-amber-800 border border-amber-200 rounded-full text-sm font-medium",
  error: "inline-flex items-center gap-1.5 px-2.5 py-1 bg-red-100 text-red-800 border border-red-200 rounded-full text-sm font-medium",
  ...
  neutral: "inline-flex items-center gap-1.5 px-2.5 py-1 bg-gray-100 text-gray-800 border border-gray-200 rounded-full text-sm font-medium",
  purple: "inline-flex items-center gap-1.5 px-2.5 py-1 bg-purple-100 text-purple-800 border border-purple-200 rounded-full text-sm font-medium",
}
...
export const iconButton = {
  primary: "p-2.5 text-blue-600 hover:bg-blue-50 rounded-lg transition-colors active:scale-95 min-w-[44px] min-h-[44px] flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-blue-300",
  success: "p-2.5 text-green-600 hover:bg-green-50 rounded-lg transition-colors active:scale-95 min-w-[44px] min-h-[44px] flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-green-300",
  warning: "p-2.5 text-amber-600 hover:bg-amber-50 rounded-lg transition-colors active:scale-95 min-w-[44px] min-h-[44px] flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-amber-300",
  danger: "p-2.5 text-red-600 hover:bg-red-50 rounded-lg transition-colors active:scale-95 min-w-[44px] min-h-[44px] flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-red-300",
  ghost: "p-2.5 text-gray-600 hover:bg-gray-100 rounded-lg transition-colors active:scale-95 min-w-[44px] min-h-[44px] flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-gray-300",
}
