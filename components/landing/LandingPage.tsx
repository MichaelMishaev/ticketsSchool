...
export default function LandingPage() {
  ...
  const exampleUrl = `https://kartis.info/p/example/mshhv-kbvtzty`
    ...
    <div className="min-h-screen bg-white text-gray-900 overflow-x-hidden">
        ...
        <div className="max-w-7xl mx-auto relative">
          <div className="text-center space-y-8">
            ...
            <p className="text-base sm:text-xl lg:text-2xl text-gray-600 leading-relaxed max-w-3xl mx-auto font-medium">
              מערכת ניהול כרטיסים מלאה עם רישום מקוון, מגבלת מקומות, רשימת המתנה חכמה וניהול משתתפים
              בזמן אמת. כל מה שצריך כדי לארגן כל אירוע – במקום אחד.
            </p>
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-4 pt-4">
              <Link
                href="/admin/signup"
                className="px-8 sm:px-12 py-4 sm:py-5 text-lg sm:text-xl font-bold text-white bg-gradient-to-r from-red-600 to-purple-600 rounded-xl hover:from-red-700 hover:to-purple-700 hover:shadow-xl transition-all max-w-[80%] sm:max-w-none"
              >
                התחילו עכשיו בחינם
              </Link>
              <Link
            ...
            <div className="text-center space-y-4 sm:space-y-5">
              ...
              <div className="bg-gradient-to-br from-purple-50 to-blue-50 rounded-xl p-5 sm:p-6 border border-purple-200">
                <p className="text-base sm:text-lg text-gray-800 leading-relaxed mb-3">
                  פשוט יוצרים אירוע ב־<span className="font-bold text-red-600">Kartis.info</span>,
                  מגדירים את התנאים,
              ...
              <div className="bg-green-50 rounded-xl p-5 sm:p-6 border-2 border-green-300">
                ...
                <p className="mt-3 text-lg sm:text-xl font-black text-green-900">רק סדר ונוחות.</p>
              </div>
            ...
            {[
              {
                ...
                description:
                  'צרו אירוע מלא תוך 3 דקות עם כל הפרטים: תאריך, מיקום, הגבלת משתתפים ושדות מותאמים אישית',
              ...
              },
              {
                ...
                description:
                  'כשהאירוע מתמלא, המערכת מעבירה משתתפים אוטומטית לרשימת המתנה ומנהלת אותם בצורה חכמה',
              ...
              },
              {
                ...
                description:
                  'הזמינו עמיתים עם הרשאות שונות: מנהל מלא, עורך או צופה בלבד. שיתוף פעולה קל ובטוח',
              ...
              },
              {
                ...
                description:
                  'הורידו את כל רשימת המשתתפים לקובץ CSV עם כל השדות המותאמים בלחיצת כפתור',
              ...
              >
                ...
                <h3 className="text-2xl font-bold mb-3 text-gray-900 text-right">
                  {feature.title}
                </h3>
            ...
            {[
              ...
              <div key={idx} className="relative">
                <div className="bg-white border-2 border-gray-200 rounded-3xl p-8 text-center hover:shadow-2xl hover:border-red-300 transition-all duration-300 hover:-translate-y-2">
                  <div
                    className={`w-20 h-20 bg-gradient-to-br ${item.color} text-white rounded-2xl flex items-center justify-center text-3xl font-black mx-auto mb-6 shadow-xl relative z-10`}
                  >
                    {item.step}
                  </div>
      ...
      >
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-lg sm:text-2xl text-gray-600">3 צעדים פשוטים וגמרנו</p>
          </div>
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-4 sm:p-8 lg:p-12 border-2 border-gray-100">
            <div className="space-y-8 sm:space-y-10">
              ...
              <div className="flex gap-3 sm:gap-6">
                ...
                <div className="flex-1 text-right">
                  <h3 className="text-lg sm:text-2xl lg:text-3xl font-bold mb-2 sm:mb-4 text-gray-900">
                    לחצו על "כניסה למערכת"
                  </h3>
                  <p className="text-sm sm:text-lg lg:text-xl text-gray-700 leading-relaxed">
                    זה הכפתור הלבן למעלה בעמוד. אפשר גם ללחוץ
                    <Link
                      href="/admin/login"
                      className="inline-block text-red-600 font-bold underline mx-1 sm:mx-2"
                    >
                      כאן
                    </Link>
                  </p>
              ...
              <div className="space-y-4">
                ...
                <div className="bg-green-50 rounded-xl p-4 sm:p-6 space-y-3 sm:space-y-4 w-full flex flex-col items-center">
                  ...
                  <div className="text-center text-gray-400 text-sm sm:text-base font-medium">
                    או
                  </div>
                  <div className="flex items-center gap-2 sm:gap-3">
                    <span className="text-base sm:text-xl font-bold text-gray-900">
            ...
            <div className="mt-12 pt-8 border-t-2 border-gray-100 text-center">
              ...
              <p className="mt-4 text-sm sm:text-base text-gray-600">לוקח 2 דקות ⏱️</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            {[
              ...
              <div
                key={idx}
                className="bg-gradient-to-br from-gray-50 to-white border-2 border-gray-200 rounded-2xl p-6 text-right hover:border-red-300 hover:shadow-lg transition-all"
              >
      ...
      <section className="py-32 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-red-500 via-red-600 to-purple-600 text-white relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          <p className="mt-8 text-lg opacity-90">התחילו תוך דקות • תמיכה בעברית 24/7</p>
        </div>
      </section>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li>
                  <Link
                    href="/admin/signup"
                    className="inline-block py-2 hover:text-white transition-colors font-medium"
                  >
                    התחל עכשיו
                  </Link>
                </li>
