...
import ShareOptionsModal from '@/components/admin/event-details/ShareOptionsModal'
      ...
      <div className="relative overflow-hidden bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
        ...
        <div className="relative p-4">
          ...
          <div className="mb-3">
            <div className="flex items-center justify-between mb-1">
              <button
                ...
                className="p-1.5 bg-purple-100 rounded-lg hover:bg-purple-200 active:scale-95 transition-all"
                aria-label="שתף"
              >
          ...
          <div className="bg-gray-50 rounded-lg px-3 py-2 mb-3">
            <p className="text-xs text-gray-600 font-mono truncate select-all text-right">
              {shareUrl}
            </p>
          </div>
