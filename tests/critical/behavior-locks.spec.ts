...
test.describe('Behavior Locks - Critical System Invariants', () => {
  ...
  test.describe('API Sort Order Locks', () => {
     ...
     * @created 2025-12-18
     */
    test('registrations list maintains createdAt ASC sort order', async ({
      page,
      request,
    }) => {
  ...
  test.describe('Tenant Isolation Locks', () => {
     ...
     * @created 2025-12-18
     */
    test('cross-school access attempts return 403 Forbidden', async ({
      page,
      request,
    }) => {
     ...
     * @created 2025-12-18
     */
    test('admin without schoolId gets 403 with descriptive error', async ({
      page,
      request,
    }) => {
  ...
  test.describe('Soft Delete Behavior Locks', () => {
     ...
     * @created 2025-12-18
     */
    test('CANCELLED registrations excluded from spotsReserved count', async ({
      page,
      request,
    }) => {
  ...
  test.describe('API Response Shape Locks', () => {
     ...
     * @created 2025-12-18
     */
    test('GET /api/events returns expected response shape', async ({
      page,
      request,
    }) => {
     ...
     * @created 2025-12-18
     */
    test('POST /api/events returns complete created event object', async ({
      page,
      request,
    }) => {
     ...
     * @created 2025-12-18
     */
    test('error responses maintain consistent {error: string} shape', async ({
      request,
    }) => {
  ...
  test.describe('Permission Boundary Locks', () => {
     ...
     * @created 2025-12-18
     */
    test('ADMIN role can create events in their school', async ({
      page,
      request,
    }) => {
     ...
     * @created 2025-12-18
     */
    test('MANAGER role can view but cannot create events', async ({
      page,
      request,
    }) => {
     ...
     * @created 2025-12-18
     */
    test('SUPER_ADMIN retains full access to all resources', async ({
      page,
      request,
    }) => {
  ...
  test.describe('Side Effect Locks', () => {
     ...
     * @created 2025-12-18
     */
    test('creating registration increments spotsReserved counter', async ({
      page,
      request,
    }) => {
     ...
     * @created 2025-12-18
     */
    test('cancelling registration decrements spotsReserved counter', async ({
      page,
      request,
    }) => {
