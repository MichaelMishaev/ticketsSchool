...
test.describe('Leads Management', () => {
  ...
  test('should show all leads grouped by phone number', async ({ page }) => {
    // Create 2 events
    const event1 = await createEvent().withTitle('Event 1').withSchool(schoolId).create()

    const event2 = await createEvent().withTitle('Event 2').withSchool(schoolId).create()
  ...
  test('should filter leads by event', async ({ page }) => {
    const event1 = await createEvent().withTitle('Soccer Game').withSchool(schoolId).create()

    const event2 = await createEvent().withTitle('Basketball Game').withSchool(schoolId).create()
  ...
  test('should filter leads by status', async ({ page }) => {
    const event = await createEvent().withTitle('Test Event').withSchool(schoolId).create()
  ...
  test('should enforce multi-tenant isolation', async ({ page }) => {
    ...
    const event = await createEvent().withTitle('My Event').withSchool(schoolId).create()
  ...
  test('should display stats cards with correct counts', async ({ page }) => {
    const event = await createEvent().withTitle('Stats Test Event').withSchool(schoolId).create()
  ...
  test('should update stats when filtering', async ({ page }) => {
    const event1 = await createEvent().withTitle('Event A').withSchool(schoolId).create()

    const event2 = await createEvent().withTitle('Event B').withSchool(schoolId).create()
