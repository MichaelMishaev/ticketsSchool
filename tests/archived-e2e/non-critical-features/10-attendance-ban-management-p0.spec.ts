...
test.describe('Attendance & Ban Management (P0)', () => {
  ...
  test('should display attendance review page with no-shows', async ({ page }) => {
    ...
    const event = await createEvent().withSchool(school.id).withTitle('Past Event').create()
  ...
  test('should load attendance history on demand', async ({ page }) => {
    ...
    const pastEvent1 = await createEvent().withSchool(school.id).withTitle('Past Event 1').create()

    const pastEvent2 = await createEvent().withSchool(school.id).withTitle('Past Event 2').create()
  ...
  test('should create game-based ban for selected users', async ({ page }) => {
    ...
    const event = await createEvent().withSchool(school.id).withTitle('Event to Ban From').create()
  ...
  test('should create date-based ban', async ({ page }) => {
    ...
    const event = await createEvent().withSchool(school.id).withTitle('Event for Date Ban').create()
