...
export async function PATCH(
  ...
  try {
    ...
    console.log(
      '[Registration PATCH] Authentication check:',
      ...
      async (tx) => {
        ...
        `
          ...
          if (useSpotsReserved) {
            ...
            const spotsNeeded = isPromotingToConfirmed
              ? newSpotsCount
              : newSpotsCount - oldSpotsCount
          ...
          `
            ...
            if (updated === 0) {
              ...
              throw new Error(
                `Cannot promote: only ${spotsLeft} spots remaining, but registration requires ${spotsNeeded} more spots`
              )
            }
          } else {
          ...
          `
            ...
            if (spotsLeft < newSpotsCount) {
              throw new Error(
                `Cannot promote: only ${spotsLeft} spots remaining, but registration requires ${newSpotsCount} spots`
              )
            }
          }
