...
export default function HelpWikiPage() {
  ...
  const [activeTab, setActiveTab] = useState<'events' | 'table-events'>('events')
            ...
            <article className="max-w-4xl mx-auto">
              ...
              <nav className="hidden lg:flex items-center gap-2 text-sm text-gray-500 mb-6">
                ...
                <button
                  onClick={() => {
                    setSelectedFeature(null)
                    const categoryId = selectedFeature.category
                ...
                <ReactMarkdown
                  components={{
                    code: ({ node, className, children, ...props }: any) => {
                      ...
                      return !inline ? (
                        <div className="relative group my-4 -mx-2 sm:mx-0">
              ...
              {selectedFeature.examples && selectedFeature.examples.length > 0 && (
                <div className="mb-8 lg:mb-12">
                  <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 mb-4 sm:mb-6 flex items-center gap-2">
            ...
            <div className="max-w-5xl mx-auto">
              ...
              `}>
                ...
                {activeTab === 'events' ? (
                  ...
                  <div className="grid md:grid-cols-3 gap-6">
                    <div className="bg-white rounded-xl p-6 border-2 border-white hover:border-green-300 transition-all duration-200 shadow-sm">
